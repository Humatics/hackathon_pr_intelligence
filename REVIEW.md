...
After completing the review, post it as a GitHub PR comment using this exact structure:
...
**Verdict:** Approve / Request Changes / Reject — <one-sentence rationale>

---
*Review generated by Claude Code against [REVIEW.md](./REVIEW.md)*
```

Use `gh pr comment <PR_NUMBER> --repo Humatics/hackathon_pr_intelligence --body "<review>"` to post.
